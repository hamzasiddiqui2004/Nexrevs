            ...
            <div className="col-lg-6" >
              <div className="service-info pr-50">
                <div className="info-head">
                  <h2 className="title"style={{color:"#ffffff"}}>Services Description</h2>
                  <p style={{color:"#ffffff"}}>
                  Elevate your online presence with Nexrevs's Website Development – where innovation meets precision, crafting websites that captivate and engage
                  </p>
                </div>
...
export default ServiceStyleTwoWebApp;
