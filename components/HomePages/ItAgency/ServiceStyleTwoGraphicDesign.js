...
const ServiceStyleTwoGraphicDesign = () => {
  return (
    <>
            ...
            <div className="col-lg-6" >
              <div className="service-info pr-50">
                <div className="info-head">
                  <h2 className="title"style={{color:"#ffffff"}}> Graphic Design</h2>
                  <p style={{color:"#ffffff"}}>
               Where creativity meets communication, transforming ideas into visually compelling stories.
                  </p>
                </div>
                ...
                <div className="row">
                  <div className="col-sm-6">
                    <div className="feature-list" >
                      ...
                      {/* Responsive Design */}
                      Brand Building Designing 

                    </div>
                    <div className="feature-list">
                      <i className="fa-solid fa-circle-check"></i>
                      {/* Mobile App Development */}
                      Gaming Stuff Designing
                    </div>
                    <div className="feature-list">
                      <i className="fa-solid fa-circle-check"></i>
                      Animation
                ...
                <div className="service-read-more">
                  <Link href="/graphic-design/" className="btn btn-primary">
...
export default ServiceStyleTwoGraphicDesign;
