...
const ServiceStyleTwoDigitalMarketing  = () => {
  return (
    <>
            ...
            <div className="col-lg-6" >
              <div className="service-info pr-50">
                <div className="info-head">
                  <h2 className="title"style={{color:"#ffffff"}}>Digital Marketing</h2>
                  <p style={{color:"#ffffff"}}>
                  At Nexrevs, we are more than marketers; we are architects of digital experiences.
                  </p>
                </div>
                ...
                <div className="service-read-more">
                  <Link href="/digital-market/" className="btn btn-primary">
...
export default ServiceStyleTwoDigitalMarketing;
