...
const WebDevelopmentPortfolioDetailsContent = () => {
  return (
    <>
          ...
          <div className="row m-0">
            <div className="col-lg-4 col-md-6 p-0">
              <div className="portfolio-details-image">
                <img src="/images/portfolio/web4.png" alt="image" />
              </div>

              <div className="portfolio-details-image">
                <img src="/images/portfolio/web2.png" alt="image" />
              </div>
            </div>

            <div className="col-lg-4 col-md-6 p-0">
              <div className="portfolio-details-image">
                <img src="/images/portfolio/web5.png" alt="image" />
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-12 p-0">
              <div className="row">
                <div className="col-lg-12 col-md-6 pr_0">
                  <div className="portfolio-details-image">
                    <img src="/images/portfolio/web1.png" alt="image" />
                  </div>
                </div>
                <div className="col-lg-12 col-md-6 pl_0">
                  <div className="portfolio-details-image">
                    <img src="/images/portfolio/web3.png" alt="image" />
                  </div>
                </div>
              </div>
            </div>
...
export default WebDevelopmentPortfolioDetailsContent;
