...
const DigitalMarketPortfolioDetailsContent = () => {
  return (
    <>
          ...
          <div className="row m-0">
            <div className="col-lg-4 col-md-6 p-0">
              <div className="portfolio-details-image">
                <img src="/images/portfolio/digital1.png" alt="image" />
              </div>

              <div className="portfolio-details-image">
                <img src="/images/portfolio/digital3.png" alt="image" />
              </div>
            </div>

            <div className="col-lg-4 col-md-6 p-0">
              <div className="portfolio-details-image">
                <img src="/images/portfolio/digital5.png" alt="image" />
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-12 p-0">
              <div className="row">
                <div className="col-lg-12 col-md-6 pr_0">
                  <div className="portfolio-details-image">
                    <img src="/images/portfolio/digital2.png" alt="image" />
                  </div>
                </div>
                <div className="col-lg-12 col-md-6 pl_0">
                  <div className="portfolio-details-image">
                    <img src="/images/portfolio/digital4.png" alt="image" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row" >
            <div className="col-lg-12" >
              <div className="portfolio-desc" >
                <h2 style={{color:"white"}}>Wes Provide Useful Services</h2>
                <p style={{color:"white"}}>
                ...
                <h2 style={{color:"white"}}>Core Development</h2>
                <p style={{color:"white"}}>
                ...
                <h2 style={{color:"white"}}>Define Your Choices</h2>
                <p style={{color:"white"}}>
...
export default DigitalMarketPortfolioDetailsContent;
