...
const GraphicDesignPortfolioDetailsContent = () => {
  return (
    <>
          ...
          <div className="row m-0">
            <div className="col-lg-4 col-md-6 p-0">
              <div className="portfolio-details-image">
                <img src="/images/portfolio/graphic1.png" alt="image" />
              </div>

              <div className="portfolio-details-image">
                <img src="/images/portfolio/graphic4.png" alt="image" />
              </div>
            </div>

            <div className="col-lg-4 col-md-6 p-0">
              <div className="portfolio-details-image">
                <img src="/images/portfolio/graphic2.png" alt="image" />
              </div>
            </div>
            ...
            <div className="col-lg-4 col-md-12 p-0">
              <div className="row">
                <div className="col-lg-12 col-md-6 pr_0">
                  <div className="portfolio-details-image">
                    <img src="/images/portfolio/graphic3.png" alt="image" />
                  </div>
                </div>
                <div className="col-lg-12 col-md-6 pl_0">
                  <div className="portfolio-details-image">
                    <img src="/images/portfolio/graphic5.png" alt="image" />
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row" >
            <div className="col-lg-12" >
              <div className="portfolio-desc" >
                <h2 style={{color:"white"}}>We Provide Useful Services</h2>
                <p style={{color:"white"}}>
...
export default GraphicDesignPortfolioDetailsContent;
